...
@Controller
@RequestMapping("/sample/*") // /sample/ 다음에 오는 애는 몽땅 얘가 처리
@Log4j
public class SampleController {

	@RequestMapping("") // @RequestMapping는 클래스에도, 메서드에도 붙있수 있음
	public void basic() {
		log.info("basic----------"); // url에 sample + / 까지 쳐줘야 로그가 뜸
	}
	...
	@GetMapping("/ex01") // /ex01로 들어오면 처리할거야
